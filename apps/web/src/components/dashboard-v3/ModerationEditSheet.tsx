                ...
                >
                    ...
                    >
                      <span
                        className={`inline-block h-5 w-5 rounded-full shadow-[var(--shadow-elev-1)] transition ${
                          isSwitchDisabled
                            ? "translate-x-1 bg-[color:var(--color-text-subtle)]"
                            : isPaused
                  ...
                  <label className="mt-3 block text-sm text-[color:var(--color-text)]">
                    ...
                    <div className="relative mt-2 h-8">
                      ...
                      />
                      <input
                        className="absolute inset-0 z-20 h-full w-full appearance-none bg-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-accent-primary)]/45 focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--color-overlay-1)] [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border [&::-moz-range-thumb]:border-[color:var(--color-border-strong)] [&::-moz-range-thumb]:bg-[color:var(--color-semantic-success-500)] [&::-moz-range-thumb]:shadow-[var(--shadow-elev-1)] [&::-moz-range-track]:h-2 [&::-moz-range-track]:rounded-full [&::-moz-range-track]:bg-transparent [&::-webkit-slider-runnable-track]:h-2 [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-transparent [&::-webkit-slider-thumb]:relative [&::-webkit-slider-thumb]:z-20 [&::-webkit-slider-thumb]:mt-[-4px] [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-[color:var(--color-semantic-success-500)] [&::-webkit-slider-thumb]:bg-[color:var(--color-semantic-success-500)] [&::-webkit-slider-thumb]:shadow-[var(--shadow-elev-1)]"
                        type="range"
                        min={0}
                        max={7}
                        step={1}
