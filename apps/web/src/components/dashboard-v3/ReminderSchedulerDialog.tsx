      ...
      {isOpen ? (
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 bottom-0 flex max-h-[95vh] flex-col rounded-t-3xl border border-white/10 bg-surface/95 p-5 shadow-2xl md:inset-auto md:left-1/2 md:top-1/2 md:max-h-[85vh] md:w-[560px] md:-translate-x-1/2 md:-translate-y-1/2 md:rounded-3xl"
