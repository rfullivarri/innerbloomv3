...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <p><strong>Last updated:</strong> 2026-04-12</p>
      <p>
      ...
      <section><h2 className="mb-2 text-xl font-semibold">8. Third-party providers and processors</h2><ul className="list-disc space-y-1 pl-6"><li><strong>Clerk</strong> for authentication</li><li><strong>Resend</strong> for email delivery and related email operations</li><li>hosting and infrastructure providers used to run the product</li><li><strong>Google Analytics 4</strong> for analytics on the web experience, subject to consent where required</li><li>payment providers, if subscriptions or billing features are enabled</li></ul></section>
