...
export default function LabsDemoModeSelectPage() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-4 py-8 sm:px-6 md:max-w-3xl md:px-8 md:py-10 lg:max-w-5xl lg:px-10 lg:py-14">
        <section className="relative isolate overflow-hidden rounded-[2rem] border border-white/12 bg-[linear-gradient(140deg,rgba(255,255,255,0.085),rgba(167,123,245,0.075)_48%,rgba(72,43,126,0.05))] px-5 py-6 shadow-[0_22px_56px_rgba(26,12,52,0.22),inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-[20px] sm:px-6 sm:py-7 md:rounded-[2.35rem] md:px-10 md:py-10 md:shadow-[0_28px_80px_rgba(26,12,52,0.28),inset_0_1px_0_rgba(255,255,255,0.2)] lg:px-14 lg:py-12">
          ...
          <div className="relative space-y-5 text-center sm:space-y-6 md:space-y-7">
            <BrandWordmark
            ...
            <div className="space-y-3 md:space-y-4">
              <h1 className="mx-auto max-w-[12ch] text-balance text-[2rem] font-semibold leading-[1.04] tracking-[-0.03em] text-white sm:max-w-[13ch] sm:text-[2.2rem] md:max-w-[15ch] md:text-[2.75rem] md:leading-[1.02] lg:text-[3.15rem]">
                {copy.title}
              </h1>
              <p className="mx-auto max-w-[32ch] text-sm leading-6 text-white/78 sm:text-[0.96rem] sm:leading-7 md:max-w-[42ch] md:text-[1.02rem] md:leading-7 lg:text-[1.08rem]">
                {copy.subtitle}
              </p>
            </div>
          </div>

          <div className="relative mt-6 grid grid-cols-2 gap-3 sm:mt-7 sm:gap-4 md:mt-10 md:gap-5 lg:mt-12 lg:gap-6">
            {cards.map((card) => (
              <Link
                key={card.id}
                to={card.href}
                className="group relative flex min-w-0 flex-col overflow-hidden rounded-[1.55rem] border border-white/10 bg-white/[0.04] shadow-[0_14px_30px_rgba(26,12,52,0.14),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-sm transition duration-200 ease-out hover:-translate-y-0.5 hover:border-white/16 hover:bg-white/[0.055] hover:shadow-[0_18px_36px_rgba(26,12,52,0.18),inset_0_1px_0_rgba(255,255,255,0.12)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/70 md:rounded-[1.8rem] md:shadow-[0_20px_42px_rgba(26,12,52,0.18),inset_0_1px_0_rgba(255,255,255,0.1)]"
              >
                ...
                <div className="aspect-[0.86/1] overflow-hidden bg-[linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.02))] md:aspect-[0.92/1]">
                  <img
                    src={card.image}
                    alt=""
                ...
                <div className="relative border-t border-white/8 bg-[linear-gradient(180deg,rgba(19,14,43,0.08),rgba(19,14,43,0.18))] px-2.5 py-3 text-center md:px-4 md:py-4">
