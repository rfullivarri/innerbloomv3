    ...
    >
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-4 py-8 sm:px-6">
        <section className="relative isolate overflow-hidden rounded-[2rem] border border-white/12 bg-[linear-gradient(140deg,rgba(255,255,255,0.085),rgba(167,123,245,0.075)_48%,rgba(72,43,126,0.05))] px-5 py-6 shadow-[0_22px_56px_rgba(26,12,52,0.22),inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-[20px] sm:px-6 sm:py-7">
          <div className="pointer-events-none absolute inset-x-2 -top-3 h-24 rounded-full bg-[radial-gradient(circle_at_50%_52%,rgba(176,122,255,0.3),rgba(176,122,255,0.08)_54%,transparent_74%)] blur-[18px]" />
          <div className="pointer-events-none absolute inset-y-8 left-1/2 w-[90%] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(168,115,255,0.2),rgba(168,115,255,0.06)_44%,transparent_72%)] blur-3xl" />
          <div className="pointer-events-none absolute -bottom-10 right-0 h-40 w-[56%] rounded-full bg-[radial-gradient(circle_at_center,rgba(126,95,255,0.16),transparent_64%)] blur-3xl" />
          ...
          <div className="relative space-y-4 text-center sm:space-y-5">
            <span className="inline-flex items-center justify-center rounded-full border border-white/12 bg-white/[0.075] px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.26em] text-white/72 shadow-[inset_0_1px_0_rgba(255,255,255,0.16)] backdrop-blur-md">
              {copy.badge}
            </span>
          ...
          <div className="relative mt-6 grid grid-cols-2 gap-3 sm:mt-7 sm:gap-4">
            {cards.map((card) => (
              <Link
                key={card.id}
                to={card.href}
                className="group relative flex min-w-0 flex-col overflow-hidden rounded-[1.55rem] border border-white/10 bg-white/[0.04] shadow-[0_14px_30px_rgba(26,12,52,0.14),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-sm transition duration-200 ease-out hover:-translate-y-0.5 hover:border-white/16 hover:bg-white/[0.055] hover:shadow-[0_18px_36px_rgba(26,12,52,0.18),inset_0_1px_0_rgba(255,255,255,0.12)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/70"
              >
                ...
                <div className="aspect-[0.86/1] overflow-hidden bg-[linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.02))]">
                  <img
                    src={card.image}
                    alt=""
                ...
                <div className="relative border-t border-white/8 bg-[linear-gradient(180deg,rgba(19,14,43,0.08),rgba(19,14,43,0.18))] px-2.5 py-3 text-center">
