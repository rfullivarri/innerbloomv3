...
export const LANDING_V2_CONTENT: Record<Language, LandingCopy> = {
  es: {
    ...
    how: {
      kicker: 'MÉTODO SIMPLE',
      title: 'Empezás con poco. Ajustás con el tiempo.',
      intro: 'No solo marca hábitos. Te ayuda a sostenerlos.',
      closingLine: 'Tu progreso deja señales: ritmo, GP, rachas y dificultad.',
      closingBody: 'Innerbloom usa esas señales para ajustar la experiencia.',
      steps: [
        {
          title: 'Elegí tu ritmo',
          badge: 'PASO 1',
          bullets: ['Low, Chill, Flow o Evolve.'],
          chips: [],
        },
        {
          title: 'Activá tus primeros hábitos',
          badge: 'PASO 2',
          bullets: ['Body, Mind y Soul ordenan tu punto de partida.'],
          chips: [],
        },
        {
          title: 'Sumá progreso real',
          badge: 'PASO 3',
          bullets: ['Completá tareas, ganá GP y sostené rachas.'],
          chips: [],
        },
        {
          title: 'Dejá que el sistema se ajuste',
          badge: 'PASO 4',
          bullets: ['Más liviano cuando cuesta. Más desafiante cuando avanzás.'],
          chips: [],
        },
      ],
    },
  ...
  en: {
    ...
    how: {
      kicker: 'SIMPLE METHOD',
      title: 'Start small. Adjust over time.',
      intro: 'It doesn’t just track habits. It helps you sustain them.',
      closingLine: 'Your progress leaves signals: pace, GP, streaks, and difficulty.',
      closingBody: 'Innerbloom uses those signals to adjust the experience.',
      steps: [
        { title: 'Choose your pace', badge: 'STEP 1', bullets: ['Low, Chill, Flow, or Evolve.'], chips: [] },
        { title: 'Activate your first habits', badge: 'STEP 2', bullets: ['Body, Mind, and Soul organize your starting point.'], chips: [] },
        { title: 'Build real progress', badge: 'STEP 3', bullets: ['Complete tasks, earn GP, and sustain streaks.'], chips: [] },
        { title: 'Let the system adjust', badge: 'STEP 4', bullets: ['Lighter when life gets harder. More challenging when you’re progressing.'], chips: [] },
      ],
    },
    featureShowcase: { kicker: '', title: '', intro: '', items: [] },
    demo: {
