...
const LANDING_V3_BASE_CONTENT: Record<Language, LandingCopy> = {
  es: {
    navLinks: [],
    hero: {
...
export const LANDING_V3_CONTENT: Record<Language, LandingCopy> = {
  es: {
    ...LANDING_V3_BASE_CONTENT.es,
    how: {
      ...LANDING_V3_BASE_CONTENT.es.how,
      steps: [
        {
    ...
    demo: {
      ...LANDING_V3_BASE_CONTENT.es.demo,
      title: 'Mira tu Journey.',
      text: 'Energía, emociones, acciones, GP y rachas en una experiencia simple de seguir.',
    },
  },
  en: {
    ...LANDING_V3_BASE_CONTENT.en,
    how: {
      ...LANDING_V3_BASE_CONTENT.en.how,
      steps: [
        {
    ...
    demo: {
      ...LANDING_V3_BASE_CONTENT.en.demo,
