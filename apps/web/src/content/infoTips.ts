...
const localizedInfoTips: Record<InfoKey, LocalizedInfoTip> = {
  ...
  dailyEnergy: {
    ...
    en: {
      title: 'What is Daily Energy?',
      bullets: [
        '🫀 **HP** → linked to **Body**.',
        '🏵️ **Mood** → linked to **Soul**.',
        '🧠 **Focus** → linked to **Mind**.',
        '🔋 They charge with your activities (last 7 days).',
        '💡 Keeping them high gives you motivation and consistency.',
      ],
    },
  },
  dailyCultivation: {
