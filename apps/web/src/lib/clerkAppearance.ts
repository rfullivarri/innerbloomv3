...
const baseElements = {
  ...
  card:
    'mx-auto flex !w-full !min-w-0 !max-w-full w-full min-w-0 max-w-full flex-col gap-6 overflow-hidden rounded-[24px] border border-white/10 bg-white/5 p-4 shadow-[0_25px_80px_rgba(15,23,42,0.35)] backdrop-blur-2xl sm:!max-w-[420px] sm:rounded-[28px] sm:p-6 md:p-8',
  header: 'hidden',
