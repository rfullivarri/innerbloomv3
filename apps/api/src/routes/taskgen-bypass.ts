...
function resolveCliContext(): CliContext {
  ...
  throw new Error(
    'Task generation CLI script not found. Ensure dist/taskgen/generateTasks.ts (or scripts/generateTasks.ts) is available in the deployed bundle.',
  );
}
