    ...
    mockGetRecentWrapped.mockResolvedValue([
      {
        ...
        summary: { highlight: 'Hábito', pillarDominant: 'Body' },
        payload: {
          mode: 'final',
          dataSource: 'real',
          variant: 'full',
          weekRange: { start: '2024-10-07T00:00:00.000Z', end: '2024-10-13T00:00:00.000Z' },
          summary: { pillarDominant: 'Body', highlight: 'Hábito' },
    ...
    mockGetRecentWrapped.mockResolvedValue([
      {
        ...
        payload: {
          ...
          summary: { pillarDominant: null, highlight: null },
          emotions: { weekly: null, biweekly: null },
      ...
      },
      {
        ...
        createdAt: '2024-10-14T10:00:00.000Z',
        updatedAt: '2024-10-14T10:00:00.000Z',
        summary: { highlight: 'Body', pillarDominant: 'Body' },
        payload: {
          mode: 'final',
          dataSource: 'real',
          variant: 'light',
          weekRange: { start: '2024-10-07T00:00:00.000Z', end: '2024-10-13T00:00:00.000Z' },
          summary: { pillarDominant: 'Body', highlight: 'Body' },
          emotions: { weekly: null, biweekly: null },
          levelUp: { happened: false, currentLevel: 1, previousLevel: 1, xpGained: 0, forced: false },
          sections: [],
        },
