...
-- ============================================================================
-- Script: 095_post_refresh_bootstrap.sql
-- Objetivo: Ejecutar un primer refresh completo luego de crear las materialized views.
-- ============================================================================

BEGIN;

-- Orden garantizado: primero diaria, luego semanal.
