...
- Tamaño observado: cerca de 129 MB.
- El AAB generado actualmente está unsigned porque no existe `apps/mobile/android/keystore.properties`.
- Resultado de verificación: `jar is unsigned`.
- Conclusión: el build compila, pero todavía no es el artefacto final para Play.
...
1. Crear upload keystore real.
2. Crear `apps/mobile/android/keystore.properties` local con secretos reales, sin subirlo a Git.
3. Generar AAB firmado.
4. Verificar firma del AAB.
5. Abrir cuenta Google Play Console.
6. Crear app en Play Console con package `org.innerbloom.app`.
7. Completar App access con cuenta de prueba o instrucciones.
8. Completar Data Safety.
9. Completar Content Rating.
10. Completar Target audience / Families.
11. Subir screenshots Android.
12. Subir Play icon 512x512.
13. Subir feature graphic 1024x500.
14. Subir AAB a Internal testing.
...
- Firma/AAB real: media. Es mecánico, pero hay que guardar bien el keystore porque perderlo complica futuras actualizaciones.
...
1. Crear keystore real y generar AAB firmado.
